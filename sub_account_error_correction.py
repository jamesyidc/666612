...
规则：
- 维护次数0：目标10U（允许范围9.5-10.5U）
- 维护次数1：目标20U（允许范围19-21U）✅ 已修改从10U改为20U
...
def main_loop():
    ...
    log(f"📋 纠错规则:")
    log(f"   维护次数0: 目标10U (允许范围9.5-10.5U)")
    log(f"   维护次数1: 目标20U (允许范围19-21U) ✅ 已修改")
